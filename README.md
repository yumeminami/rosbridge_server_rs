...
[v0.1.4](https://github.com/yumeminami/rosbridge_server_rs/releases/tag/v0.1.4):
...
Version 0.1.4 manages `~/.rosbridge_server_rs/rosbridge.toml` as a versioned
...
topics_glob = []
topics_pub_glob = []
topics_sub_glob = ["/diagnostics", "/imu", "/button"]
