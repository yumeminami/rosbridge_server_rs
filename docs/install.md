...
Version 0.1.2 targets ROS 2 Humble on Ubuntu 22.04 and ROS 2 Jazzy on Ubuntu
...
[the release page](https://github.com/yumeminami/rosbridge_server_rs/releases/tag/v0.1.2).
...
tar -xzf rosbridge-server-rs_0.1.2_jazzy_ubuntu24.04_amd64.tar.gz
